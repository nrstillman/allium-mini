...
class Sim(object):
    ...
    def simulate(self, params):
        ...
        for t in range(params.t_final):
            ...
            if (t/params.output_time > 100):# & (sim.popSize() > self.maxN):
                t_final = int(t/params.output_time)
                self.starttime = [t_final - 100]
                self.endtime = [t_final]
